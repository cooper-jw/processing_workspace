...
public class a221201 extends PApplet {
...
int lineColor = color(253, 253, 253);
int lineAlpha = 10;
float lineStrokeWeight = 2.0f;

float linesMin = 1.0f;
float linesMax = 3.0f;
float wavesMin = 5.0f;
float wavesMax = 7.0f;
float radiusPercent = 0.2f;
float stepMin = 1.0f;
float stepMax = 6.0f;
float stepMult = 0.05f;
...
smooth(8); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "a221201" };
    if (passedArgs != null) {
